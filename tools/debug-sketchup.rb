# Helper script to allow RubyMine to launch SketchUp with Ruby debugger enabled.
# https://github.com/SketchUp/sketchup-ruby-api-tutorials/wiki/RubyMine-Debugger-Setup
#
# Remember to install the SketchUp Ruby Debugger into the SketchUp application package:
# https://github.com/SketchUp/sketchup-ruby-debugger

# This file accepts an argument which specify which SketchUp version to load.
...
if RUBY_PLATFORM.include?('darwin')
  ...
  sketchup_relative = File.join("SketchUp/SketchUp #{version}")

  if sketchup_version >= 25
    # SketchUp 2025 and newer use a different folder structure.
    sketchup_relative = File.join(sketchup_relative, "SketchUp")
  end

  sketchup_relative = File.join(sketchup_relative, "SketchUp.exe")
